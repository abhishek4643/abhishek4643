...
Multi-disease early prediction system using **computer vision for medical image analysis**, heart monitoring, disease risk prediction + a **multilingual NLP chatbot** for patient queries. Deployed on Streamlit Cloud with concurrent multi-user sessions.

`Python` · `PyTorch` · `OpenCV` · `Streamlit` · `NLP`
...
Real-time facial emotion recognition with a **custom CNN achieving 95% accuracy** across 7 emotion classes. Full pipeline: live camera → emotion detection → YouTube music playback via Flask.
...
<img src="https://github-profile-trophy.vercel.app/?username=abhishek4643&theme=tokyonight&no-frame=false&no-bg=true&margin-w=6&margin-h=6&column=7" width="100%" alt="GitHub Trophies"/>

<br/><br/>

<!-- ◈ 3D CONTRIBUTION CALENDAR — generated by .github/workflows/3d-contrib.yml ◈ -->

<img src="https://raw.githubusercontent.com/abhishek4643/abhishek4643/main/profile-3d-contrib/profile-night-rainbow.svg" width="100%" alt="3D Contribution Calendar"/>
